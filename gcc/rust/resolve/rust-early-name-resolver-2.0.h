...
class Early : public AST::ASTVisitor
{
public:
  ...
  // FIXME: Can we have a "base" name resolution visitor which takes care of
  // setting up the Ribs properly for each kind of node?
