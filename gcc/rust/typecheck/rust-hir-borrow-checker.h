...
public:
  ...
  virtual void visit (HIR::LetStmt &let) override;
  virtual void visit (HIR::BlockExpr &block) override;
  virtual void visit (HIR::Function &function) override;
  virtual void visit (HIR::IdentifierExpr &expr) override;
  virtual void visit (HIR::ExprStmtWithoutBlock &expr) override;
  virtual void visit (HIR::ExprStmtWithBlock &expr) override;
