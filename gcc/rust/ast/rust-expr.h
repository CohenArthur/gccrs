...
class AnonConst : public ExprWithoutBlock
{
public:
...
private:
  ...
  AnonConst *clone_expr_without_block_impl () const override
  {
    return new AnonConst (*this);
  }
};

class ConstBlock : public ExprWithoutBlock /* Is that true? it feels wrong */
{
public:
...
private:
  ...
  ConstBlock *clone_expr_without_block_impl () const override
  {
