...
protected:
  ...
  TraitBound *reconstruct_type_param_bound_impl () const override
  {
...
protected:
  ...
  ImplTraitType *reconstruct_type_impl () const override
  {
    return new ImplTraitType (
      reconstruct_vec (type_param_bounds,
		       &TypeParamBound::reconstruct_type_param_bound),
      locus);
  }
...
protected:
  ...
  TraitObjectType *reconstruct_type_impl () const override
  {
    return new TraitObjectType (
      reconstruct_vec (type_param_bounds,
		       &TypeParamBound::reconstruct_type_param_bound),
      locus, has_dyn);
  }
...
protected:
  ...
  ParenthesisedType *reconstruct_type_no_bounds_impl () const override
  {
    return new ParenthesisedType (type_in_parens->reconstruct_type (), locus);
  }
...
public:
  ...
  TypeNoBounds *reconstruct_type_no_bounds_impl () const override
  {
    return new ImplTraitTypeOneBound (
      trait_bound->reconstruct_type_param_bound (), locus);
  }
};
...
protected:
  ...
  TraitObjectTypeOneBound *reconstruct_type_no_bounds_impl () const override
  {
...
protected:
  ...
  TupleType *reconstruct_type_no_bounds_impl () const override
  {
    return new TupleType (reconstruct_vec (elems, &TupleType::reconstruct_type),
			  locus);
  }
};
...
protected:
  ...
  NeverType *reconstruct_type_no_bounds_impl () const override
  {
...
protected:
  ...
  RawPointerType *reconstruct_type_no_bounds_impl () const override
  {
    return new RawPointerType (pointer_type,
			       type->reconstruct_type_no_bounds (), locus);
  }
};
...
protected:
  ...
  ReferenceType *reconstruct_type_no_bounds_impl () const override
  {
    return new ReferenceType (
      has_mut, type->reconstruct_type_no_bounds (), locus,
      // TODO: Improve this - it's ugly!
      has_lifetime ()
	? tl::make_optional<Lifetime> (lifetime->get_lifetime_type (),
...
protected:
  ...
  ArrayType *reconstruct_type_no_bounds_impl () const override
  {
    return new ArrayType (
      elem_type->reconstruct_type (),
...
protected:
  ...
  SliceType *reconstruct_type_no_bounds_impl () const override
  {
    return new SliceType (elem_type->reconstruct_type (), locus);
  }
};
...
protected:
  ...
  InferredType *reconstruct_type_no_bounds_impl () const override
  {
...
protected:
  ...
  BareFunctionType *reconstruct_type_no_bounds_impl () const override
  {
    return new BareFunctionType (
      for_lifetimes, function_qualifiers, params,
      /* FIXME: Should params be reconstruct() as well? */
      _is_variadic, variadic_attrs, return_type->reconstruct_type_no_bounds (),
      locus);
  }
};
